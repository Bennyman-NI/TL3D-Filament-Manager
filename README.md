...
- Bambu saved-dump decoding: implemented for documented fields, RSA signature assembly metadata, and exact validated Bambu catalogue-name resolution for the current local dump dataset.
